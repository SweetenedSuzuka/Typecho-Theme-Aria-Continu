...
<div id="main" class="col-mb-12 col-8 col-offset-2">
    <style>
        ...
        .archives-tags-item:before,
        .archives-cate-item:before {
        ...
        .archives-tags-item:after,
        .archives-cate-item:after {
        ...
        .archives-tags-item>a,
        .archives-cate-item>a {
            color: #fff
        }
        #timeline-container {
            position: relative
