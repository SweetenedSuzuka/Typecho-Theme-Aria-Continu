...
function ariaGetThemeConfigTransferSchema()
{
    return array(
        ...
        'enableContinuoVisuals' => array('label' => '使用 Aria Continuo 样式', 'type' => 'checkbox', 'default' => true),
        ...
        'enableImageLightbox' => array('label' => '文章/评论图片启用灯箱查看', 'type' => 'checkbox', 'default' => false),
