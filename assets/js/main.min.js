  ...
  (window.Aria = {
    init: function () {
      (this.action.init(),
        ...
        this.toc.init(),
        console.log(
          '%cVer ' + THEME_CONFIG.THEME_VERSION + '%cAria By Siphils https://eriri.ink',
    ...
    pjax: function () {
      $(document)
        .pjax(
          ...
          { container: '#pjax-container', fragment: '#pjax-container', timeout: 8e3 }
        )
    ...
    doPjaxCompleteAction: function () {
      if (
        ...
        window.ga && ga('send', 'pageview', { page: location.pathname, title: document.title }),
      ...
      if ($('#comment-avatar').length) {
        function t(t) {
          ...
          '' != e &&
            $.ajax({
              type: 'GET',
              data: { action: 'ajax_avatar_get', form: THEME_CONFIG.SITE_URL, email: e },
              success: function (t) {
      ...
      $(window).scroll(function () {
        if (
          (100 < $(window).scrollTop()
            ? ($('#go-top').fadeIn(500),
              $('#site-avatar').css({ height: '25px', width: '25px', margin: '19.5px 5px 0 0' }))
            : ($('#go-top').fadeOut(500, function () {
                $('#go-top').css('display', 'none');
              }),
              $('#site-avatar').css({ height: '35px', width: '35px', margin: '14.5px 5px 0 0' })),
          $('#toc').length)
        ) {
